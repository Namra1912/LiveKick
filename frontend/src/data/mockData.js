...
export const teams = [
  ...
  { id: 8, name: "Atletico Madrid", shortName: "ATM", league: "La Liga", country: "Spain", logoUrl: "https://raw.githubusercontent.com/luukhopman/football-logos/master/logos/Spain%20-%20LaLiga/Atl%C3%A9tico%20de%20Madrid.png", crestUrl: "https://raw.githubusercontent.com/luukhopman/football-logos/master/logos/Spain%20-%20LaLiga/Atl%C3%A9tico%20de%20Madrid.png", primaryColor: "#CB3524", secondaryColor: "#272E61" },
  {
    ...
    country: "Spain",
    city: "Barcelona",
    logoUrl: "https://raw.githubusercontent.com/luukhopman/football-logos/master/logos/Spain%20-%20LaLiga/FC%20Barcelona.png",
    crestUrl: "https://raw.githubusercontent.com/luukhopman/football-logos/master/logos/Spain%20-%20LaLiga/FC%20Barcelona.png",
    primaryColor: "#004D98",
    ...
    capacity: "99,787",
    manager: "Hansi Flick",
    stadiumOpenedYear: 1957,
    stadiumSurface: "Grass",
    honours: ["5x Champions League", "27x La Liga", "31x Copa del Rey", "3x FIFA Club World Cup"],
    formation: "4-3-3",
    lastMatchXI: [901, 905, 907, 904, 909, 912, 914, 915, 921, 919, 923],
    about: {
      bio: "Barcelona is a football club based in Barcelona, Spain, playing their home matches at Spotify Camp Nou. The club competes in La Liga and the UEFA Champions League, managed by Hansi Flick.",
      statLines: [
        {
          id: 1,
          parts: [
            { text: "Raphinha", isPlayer: true },
            { text: " has been the standout performer this season with 8 goals in La Liga. ", isPlayer: false },
            { text: "Lamine Yamal", isPlayer: true },
            { text: " and ", isPlayer: false },
            { text: "Pedri", isPlayer: true },
            { text: " have also contributed 6 assists and 4 goals respectively.", isPlayer: false },
          ],
        },
        {
          id: 2,
          parts: [
            { text: "Robert Lewandowski", isPlayer: true },
            { text: " leads the squad in goal contributions with 12 combined this season.", isPlayer: false },
          ],
        },
        {
          id: 3,
          parts: [
            { text: "Gavi", isPlayer: true },
            { text: " is the chief creator in midfield with 3.2 key passes per game. ", isPlayer: false },
            { text: "Dani Olmo", isPlayer: true },
            { text: " and ", isPlayer: false },
            { text: "Fermín López", isPlayer: true },
            { text: " have also been key contributors off the bench.", isPlayer: false },
          ],
        },
        {
          id: 4,
          parts: [
            { text: "Marc-André ter Stegen", isPlayer: true },
            { text: " has kept 4 clean sheets this season. ", isPlayer: false },
            { text: "Inigo Martinez", isPlayer: true },
            { text: " leads the defensive line with 4.1 clearances per game.", isPlayer: false },
          ],
        },
      ],
    },
...
export const matches = [
  ...
  {
    id: 140,
    homeTeam: t(9), awayTeam: t(34),
    homeScore: 2, awayScore: 0,
    status: "finished", minute: 90,
    pressureHome: 60, pressureAway: 40,
    matchDateUtc: getRelativeIso(-21, 20, 0),
    league: "La Liga", venue: "Spotify Camp Nou", referee: "César Soto Grado",
    lastSynced: new Date().toISOString(),
  },
  {
    id: 141,
    homeTeam: t(38), awayTeam: t(9),
    homeScore: 1, awayScore: 3,
    status: "finished", minute: 90,
    pressureHome: 45, pressureAway: 55,
    matchDateUtc: getRelativeIso(-25, 20, 0),
    league: "La Liga", venue: "Balaídos", referee: "José María Sánchez Martínez",
    lastSynced: new Date().toISOString(),
  },
  {
    id: 142,
    homeTeam: t(9), awayTeam: t(36),
    homeScore: 5, awayScore: 1,
    status: "finished", minute: 90,
    pressureHome: 72, pressureAway: 28,
    matchDateUtc: getRelativeIso(-28, 20, 0),
  ...
  {
    id: 143,
    homeTeam: t(97), awayTeam: t(9),
    homeScore: 0, awayScore: 0,
    status: "upcoming", minute: 0,
    pressureHome: 50, pressureAway: 50,
    matchDateUtc: getRelativeIso(7, 20, 0),
    league: "La Liga", venue: "Estadi Ciutat de València", referee: "Ricardo de Burgos",
    lastSynced: new Date().toISOString(),
  },
  {
    id: 144,
    homeTeam: t(9), awayTeam: t(98),
    homeScore: 0, awayScore: 0,
    status: "upcoming", minute: 0,
    pressureHome: 50, pressureAway: 50,
    matchDateUtc: getRelativeIso(10, 20, 0),
    league: "La Liga", venue: "Spotify Camp Nou", referee: "Mateu Lahoz",
    lastSynced: new Date().toISOString(),
  },
  {
    id: 145,
    homeTeam: t(37), awayTeam: t(9),
    homeScore: 0, awayScore: 0,
    status: "upcoming", minute: 0,
    pressureHome: 50, pressureAway: 50,
    matchDateUtc: getRelativeIso(14, 20, 0),
    league: "La Liga", venue: "Ramón Sánchez-Pizjuán", referee: "Jesús Gil Manzano",
    lastSynced: new Date().toISOString(),
  },
  {
    id: 146,
    homeTeam: t(9), awayTeam: t(85),
    homeScore: 0, awayScore: 0,
    status: "upcoming", minute: 0,
    pressureHome: 50, pressureAway: 50,
    matchDateUtc: getRelativeIso(17, 20, 0),
    league: "Champions League", venue: "Spotify Camp Nou", referee: "Szymon Marciniak",
    lastSynced: new Date().toISOString(),
  },
  {
    id: 147,
    homeTeam: t(40), awayTeam: t(9),
    homeScore: 0, awayScore: 0,
    status: "upcoming", minute: 0,
    pressureHome: 50, pressureAway: 50,
    matchDateUtc: getRelativeIso(21, 20, 0),
    league: "La Liga", venue: "Coliseum Alfonso Pérez", referee: "José María Sánchez Martínez",
    lastSynced: new Date().toISOString(),
  },
];
...
// ----------------------------------------------------- squads dataset ------
export const squads = {
  9: [ // Barcelona squad (~23 real current players + coach)
    // Coach
    { id: 900, name: "Hansi Flick", position: "Coach", shirtNumber: null, age: 59, nationality: "Germany", countryFlag: "🇩🇪", height: null, transferValue: null, photoUrl: null, rating: null, isCoach: true },

    // Goalkeepers
    { id: 901, name: "Marc-André ter Stegen", position: "GK", shirtNumber: 1, age: 33, nationality: "Germany", countryFlag: "🇩🇪", height: 193, transferValue: "€8.0M", photoUrl: null, rating: 8.4, goals: 0, assists: 0 },
    { id: 902, name: "Iñaki Peña", position: "GK", shirtNumber: 13, age: 26, nationality: "Spain", countryFlag: "🇪🇸", height: 189, transferValue: "€12.0M", photoUrl: null, rating: 7.2, goals: 0, assists: 0 },
